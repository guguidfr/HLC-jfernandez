...
def Descargar(link):
    ...
    enlace = descarga.a["href"] # Obtener el primer enlace de descarga de la página web #type: ignore
...
url = "https://www.tiktok.com/@buildinggamepc/video/7170144076715642139" # Pon aquí el enlace al vídeo de TikTok que quieras.
